...
def create_user(**params):
    """Helper function to create user from custom user model"""
...
class PublicUserApiTests(TestCase):
    ...
    def test_create_token_for_user(self):
        ...
        payload = {'email': 'testuser@sid.com', 'password': 'hellosid'}
        create_user(**payload)
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(email='testuser@sid.com', password='password1234')
        payload = {'email': 'testuser@sid.com', 'password': 'wrongpass'}
...
class PrivateUserApiTest(TestCase):
    ...
    def test_post_me_not_allowed(self):
        """Test that POST method is not allowed on the ME_URL"""
    ...
    def test_update_user_profile(self):
        ...
        payload = {'name': 'New Test Name', 'password': 'Newpassword'}
